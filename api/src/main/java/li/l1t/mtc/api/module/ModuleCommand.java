...
public class ModuleCommand extends Command implements PluginIdentifiableCommand {
    ...
    /**
     * Creates a new module command with a default description containing the module and command
     * name and a usage message hinting that the module is probably disabled if the command is not
     * registered. If the executor also implements {@link TabCompleter}, it will be used for tab
     * completion.
     *
     ...
     * @param name         the name of the command as typed by users
     * @param executor     the executor to use to execute the command
     * @param completer    the completer to use for handling tab completion, or null to complete
     *                     only player names
     * @param description  the command description to show in Bukkit's help system
     * @param usageMessage the usage message to display if the command couldn't be handled or the
    ...
    /**
     * Adds behaviours to this command. Behaviours are applied before the command executor and
     * implement common pre-execution checks.
     *
