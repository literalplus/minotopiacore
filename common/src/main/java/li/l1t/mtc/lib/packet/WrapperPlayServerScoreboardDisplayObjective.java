...
public class WrapperPlayServerScoreboardDisplayObjective extends AbstractPacket {
    ...
    /**
     * Retrieve Position. <p></p> Notes: the position of the scoreboard. 0 = list, 1 = sidebar, 2 =
     * belowName.
     *
    ...
    /**
     * Retrieve Score Name. <p></p> Notes: the unique name for the scoreboard to be displayed.
     *
