...
public class WrapperPlayServerScoreboardScore extends AbstractPacket {
    ...
    /**
     * Retrieve Score name. <p></p> Notes: the name of the score to be updated or removed.
     *
    ...
    /**
     * Retrieve Objective Name. <p></p> Notes: the name of the objective the score belongs to.
     *
    ...
    /**
     * Retrieve Value. <p></p> Notes: the score to be displayed next to the entry. Only sent when
