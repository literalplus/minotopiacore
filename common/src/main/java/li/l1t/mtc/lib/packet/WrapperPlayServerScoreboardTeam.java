...
public class WrapperPlayServerScoreboardTeam extends AbstractPacket {
    ...
    /**
     * Retrieve Team Name. <p></p> Notes: a unique name for the team. (Shared with scoreboard).
     *
    ...
    /**
     * Retrieve Team Display Name. <p> Notes: only if Mode = 0 or 2.
     *
    ...
    /**
     * Retrieve Team Prefix. <p></p> Notes: only if Mode = 0 or 2. Displayed before the players'
     * name that are part of this team.
     *
    ...
    /**
     * Retrieve Team Suffix. <p></p> Notes: only if Mode = 0 or 2. Displayed after the players' name
    ...
    /**
     * Retrieve Name Tag Visibility. <p></p> Notes: only if Mode = 0 or 2. always,
     * hideForOtherTeams, hideForOwnTeam, never.
     *
    ...
    /**
     * Retrieve Color. <p></p> Notes: only if Mode = 0 or 2. Same as Chat colors.
     *
    ...
    /**
     * Retrieve Players. <p></p> Notes: only if Mode = 0 or 3 or 4. Players to be added/remove from
     * the team. Max 40 characters so may be uuid's later
     *
    ...
    /**
     * Retrieve Mode. <p></p> Notes: if 0 then the team is created. If 1 then the team is removed.
     * If 2 the team team information is updated. If 3 then new players are added to the team. If 4
     * then players are removed from the team.
     *
