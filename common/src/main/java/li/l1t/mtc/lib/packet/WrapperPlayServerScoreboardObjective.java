...
public class WrapperPlayServerScoreboardObjective extends AbstractPacket {
    ...
    /**
     * Retrieve Objective name. <p></p> Notes: an unique name for the objective
     *
    ...
    /**
     * Retrieve Objective DisplayName. <p> Notes: only if mode is 0 or 2. The text to be displayed
     * for the score.
     *
    ...
    /**
     * Retrieve health display. <p></p> Notes: Can be either INTEGER or HEARTS
     *
    ...
    /**
     * Retrieve Mode. <p></p> Notes: 0 to create the scoreboard. 1 to remove the scoreboard. 2 to
