...
/**
 * Handles /website command, which can be used to enable and disable the player's website account as
 * well as change the password. This is eventually going to be replaced with an xLogin
