...
public class ShopItem {
     ...
     * @throws IllegalArgumentException if the new buy cost is not a positive finite number greater
     *                                  than the sell worth
     */
     ...
     * @throws IllegalArgumentException if the new buy cost is not a finite positive number less
     *                                  than the buy cost
     */
     ...
     * @throws IllegalArgumentException if the discounted price is not between the buy cost and the
     *                                  sell worth
     */
    ...
    /**
     * Serializes this item to a configuration section such that it can be reconstructed to an
     * equivalent state using {@link #deserialize(ConfigurationSection, ShopItemManager)}. The
     * serialized data will be written to a child section of the passed parent section named exactly
     * {@link #getSerializationName()}.
     *
