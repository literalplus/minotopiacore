...
public class ClanInfo {
     ...
     * @return see {@link ClanInfo#create(String, String, String, Location, String, int, int, int,
     * int)}
    ...
    /**
     * Writes values of this {@link ClanInfo} into the corresponding row in MySQL. Safe.
     */
    public void flush() {
        SafeSql sql = MTC.instance().getSql();
        if (sql == null) {
