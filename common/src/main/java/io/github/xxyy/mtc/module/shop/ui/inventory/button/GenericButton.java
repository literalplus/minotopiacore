...
public class GenericButton implements MenuButton<ShopMenu> {
    ...
    /**
     * Constructs a new generic button with a material and a click handler. An item stack with amount 1 will be created
     * as icon.
     *
    ...
    /**
     * Interface for a generic click handler handling generic click events on a generic {@link GenericButton}.
     */
