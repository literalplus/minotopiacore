...
public class LegacyFullData {
    ...
    /**
     * Converts this data into the current version of the full data storage format. Note that this does indeed create
     * the returned data in the current database, but does not delete this legacy data.
     *
...
//                    errorIdentifier, senderName, createdTimeUnix));
    ...
    /**
     * @return a humand-readable representation of this item's part id or an error message if it is invalid
     */
