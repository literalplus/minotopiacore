...
/**
 * Stores metadata related to a full item. This represents the state of the item at the time of creation, that means
 * that the owner is the initial owner. Upon a map reset, the data stored in this class persists. While this class stores
 * the metadata for a full item, {@link FullInfo} stores data relevant to the actual item in game. Note that it is not
 * guaranteed that this full item actually exists in game. that means, that it has a corresponding {@link FullInfo}.
 *
