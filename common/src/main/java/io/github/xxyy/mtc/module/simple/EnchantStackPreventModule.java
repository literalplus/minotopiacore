...
package io.github.xxyy.mtc.module.simple;
...
/**
 * Prevents enchanting of stacked items. Stacked items only cost once, so enchanting them would be cheaper and therefore
 * muste be prohibited to ensure balance.
 *
