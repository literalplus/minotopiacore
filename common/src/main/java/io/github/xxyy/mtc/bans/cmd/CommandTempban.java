...
public final class CommandTempban implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length >= 3 && !args[0].equalsIgnoreCase("help")) {
            ...
            if (plr == null) {
                OfflinePlayer oPlr = null; // Bukkit.getOfflinePlayer(args[0]); REFACTOR
                if (oPlr == null) {
            ...
            if (millisUntilExpiry < 0) {
                sender.sendMessage(MTC.banChatPrefix + "Deine Zeitangabe §6'" + args[1] + "'§b ist invalide. (" + millisUntilExpiry + ")");
                return true;
            }
