 ...
 * @since 2015-12-28
 */
public class MTCModuleCommand extends Command implements PluginIdentifiableCommand {
    ...
    private final List<CommandBehaviour> behaviours = new ArrayList<>(Arrays.asList(
            MTCBehaviours.xycCrediting(), MTCBehaviours.messagesChecking(), MTCBehaviours.mtcCrediting()
    ));
     ...
     */
    public MTCModuleCommand clearBehaviours() {
        behaviours.clear();
        return this;
    }
     ...
     */
    public MTCModuleCommand behaviour(CommandBehaviour... behaviours) {
