...
/**
 * Repository class for {@link LegacyFullData}, retrieving data from an underlying legacy MySQL database with a legacy
 * data schema.
 *
...
public class LegacyFullDataRepository {
    ...
    /**
     * Locates legacy data for a given <b>current</b> unique id. This method will query Mojang for that UUID's name
     * history and attempt to reconstruct previously owner fulls using creation dates.
     *
    ...
    /**
     * Attempts to find a list of {@link LegacyFullData} instances by a receiver player's unique id.
     *
