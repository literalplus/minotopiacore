...
public class FullInfo implements ToShortStringable {
    ...
    public String lastOwnerName = "UNCHANGED";
    ...
    private FullInfo(int id, String senderName, String receiverName, long timestamp,
            ...
            long lastseen, String lastCode, byte partId, String lastOwnerName){
        this.id = id; this.senderName = senderName; this.receiverName = receiverName;
        this.timestamp = timestamp; this.thorns = thorns; this.x = x; this.y = y;
        this.z = z; this.inEnderchest = inEnderchest; this.lastseen = lastseen; this.comment = comment;
        this.lastCode = lastCode; this.partId = partId; this.lastOwnerName = lastOwnerName;
    }
    @Override
