...
public class CommandFull implements CommandExecutor {
    ...
    private static boolean interpretStatsOwner(CommandSender sender, String[] args){
        ...
        HashMap<String, Integer> map = FullTagHelper.getTopFullOwners(startIndex);
    ...
    private static boolean interpretStatsPart(CommandSender sender){
        HashMap<Integer,Integer> map = FullTagHelper.getPartCounts();
        int sum = 0;
        if(map == null || map.isEmpty()){
            sender.sendMessage("§e(SQL-)Fehler! <2"); return true;
        }
    ...
    private static boolean interpretStatsSender(CommandSender sender, String[] args){
        ...
        HashMap<String, Integer> map = FullTagHelper.getTopFullSenders(startIndex);
        if(map == null || map.isEmpty()){
            sender.sendMessage("§eLeeres Ergebnis -> entweder SQL-Fehler oder keine Fulls registriert.");
            return true;
        }
