...
//    private static String[] desc;
	public static String build = "@BUILDNUM@";
	public static String buildDate = "@BUILDTIME@";
	public static String versionString = "@VERSION@_b@BUILDNUM@ (@BUILDTIME@)";
	public static final String pluginID="MinoTopiaCore";
	...
	public static final String TABLE_STATS = "mtc_stats";
}
